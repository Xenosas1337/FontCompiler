...
namespace SH_COMP
{
  ...
  {
  private:
    static void WriteToFontAsset(FontAsset* fontAsset, std::vector<msdf_atlas::GlyphGeometry> const& glyphData, msdfgen::Bitmap<msdf_atlas::byte, 4>& fontBitmap, msdf_atlas::FontGeometry const& fontGeometry) noexcept;
